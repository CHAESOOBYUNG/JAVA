...
public class RootController implements Initializable {
	...
	private void handleBtnBarChartAction(ActionEvent e) {
		try {
			...
			btnClose.setOnAction(e2 -> dialog.close());
	...
	public void handleTableViewMouseClicked(MouseEvent event) {
		if(event.getClickCount() != 2) return; //두번 클릭했을 경우
